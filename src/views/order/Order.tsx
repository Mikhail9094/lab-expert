...
const OrderDetail = (): JSX.Element => {
  ...
  const handlerPrintOrSaveToPDF = (
    ...
    setTimeout(() => {
      printOrDownloadDoc(docRef, print, scale)
    }, 0)
    setTimeout(() => {
      ...
      >
        <CRow>
          <CCard className="px-0">
              ...
              >
                <CForm>
                  ...
                  <div
                    ...
                    style={{
                      visibility: `${showSignature ? 'visible' : 'hidden'}`,
                    }}
                  >
                    <div
                      style={{
            ...
            >
              <CButton
                onClick={() => handlerPrintOrSaveToPDF(firstSectionRef, false)}
              ...
              <CButton
                onClick={() => handlerPrintOrSaveToPDF(firstSectionRef, true)}
                style={{ padding: '5px 50px' }}
              >
                Печать
              </CButton>
          ...
          {actDetail.id || !isView ? (
            <CCard className="mt-4 px-0">
              ...
              >
                <CButton
                  onClick={() => handlerPrintOrSaveToPDF(documentRef, false)}
                  style={{ padding: '5px 50px' }}
                >
                  Скачать
                </CButton>
                ...
                <CButton
                  onClick={() => handlerPrintOrSaveToPDF(documentRef, true)}
                  style={{ padding: '5px 50px' }}
                >
                  Печать
                </CButton>
          ...
          <CCard className="mt-4 px-0">
            ...
            >
              <CButton
                onClick={() => printOrDownloadDoc(commentRef, false)}
                style={{ padding: '5px 50px' }}
              >
                Скачать
              </CButton>
              ...
              <CButton
                onClick={() => printOrDownloadDoc(commentRef, true)}
                style={{ padding: '5px 50px' }}
              >
                Печать
              </CButton>
